    ...
    stories = [
        {
            ...
            story: ' 7년이 넘도록 일을 했지만 보호사라는 생각을 저는 한번도 안 해 봤어요. 어르신들을 모시겠다는 생각으로 일을 시작했지요.<br><br>' +
        ...
        },
        {
            ...
            story: ' 8년이 넘게 이 일을 했어요. 이렇게 오래 할 수 있었던 배경에는 어르신을 내 부모님이다 생각했기에 가능했던 것 같아요. <br><br>' +
        ...
        },
        {
            ...
            story: ' 아프신 분들을 케어하는게 쉬운일은 아니에요. 하지만 제가 갈 시간이 되면 어르신들이 저를 기다리세요. 어떤 분은 아예 문을 열어놓고 계시기도 하구요.<br><br>' +
