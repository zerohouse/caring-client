    ...
    public create2021Recipient(name: string, level: string, number:string, birth: string, address: string, phone: string, sortation: string, center: string, pname: string, relation: string, pbirth: string, pphone: string, paddress: string, contract_start: string, contract_end: string, useday: string, usestime: string, useetime: string, contract_date: string): Document {
        ...
        document.addSection({
            children: [
                ...
                this.createText(""),
                this.createText15C("방문요양 급여 비용 및 본인부담 기준(2021.01.01)"),
