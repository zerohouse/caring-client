...
export class docFamilyGiver {

    public createFamilyCaregiver(name: string, center: string, time: string, address: string, place: string, phone: string, start: string, contract: string): Document {
        ...
        document.addSection({
            children: [
                ...
                this.createText("① 임금은 기본급, 식대, 차량유지비, 법정수당(주휴수당, 연차수당, 기타수당) 등으로 구성함."),
